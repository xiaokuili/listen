      ...
      >
        ...
        >
          <div
            ...
            className={`flex flex-wrap items-center justify-center ${isTextSelectable && 'select-all'} ${
              wordState.hasWrong ? style.wrong : ''
            }`}
            style={{ maxWidth: '100%' }} // 确保不超出容器宽度
          >
            {wordState.displayWord.split('').map((t, index) => (
              <Letter
                ...
                totalLetterCount={wordState.displayWord.length}
              />
            ))}
          </div>
          {pronunciationIsOpen && (
